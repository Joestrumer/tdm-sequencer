...
module.exports = (db) => {
  ...
  router.post('/invoices', async (req, res) => {
    try {
      const { client, products, documentType, orderNumber, fraisPort, sendEmail, emailOpts, logGSheets, createHubspotDeal, isSample, businessType, sampleTaskDays } = req.body;
